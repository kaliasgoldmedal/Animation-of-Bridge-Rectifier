...
res= plot([6.5,6.5,6.75,6.25,6.75,6.25,6.75,6.25,6.75,6.25,6.5,6.5],[1,-2,-2.25,-2.5,-2.75,-3,-3.25,-3.5,-3.75,-4,-4,-7],'k');
set(res,'LineWidth',2);
text(6,-1.75,'+','FontSize',14);
text(6,-4.25,'-','FontSize',14);
...
%Formula box
plot([0 6.5 6.5,0,0],[-7.5 -7.5 -14.5 -14.5,-7.5],'Color',[0.9290 0.6940 0.1250],'LineWidth',3);
text(0.5,-8.5,'Average Voltage = $$\frac{2V_m}{\pi}$$','FontSize',10,'Interpreter','latex');
text(0.5,-10,'Average Current = $$\frac{2V_m}{\pi R}$$','FontSize',10,'Interpreter','latex');
text(0.5,-11.5,'RMS Voltage   = $$\frac{V_m}{\sqrt 2}$$','FontSize',10,'Interpreter','latex');
text(0.5,-13,'RMS Current   = $$\frac{V_m}{\sqrt 2 R}$$','FontSize',10,'Interpreter','latex');
